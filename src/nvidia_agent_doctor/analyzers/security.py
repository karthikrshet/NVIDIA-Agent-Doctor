...
from nvidia_agent_doctor.core.result import CheckResult, SecurityFinding, SectionResult
...
def analyze_security() -> SectionResult:
    ...
    if is_running_as_root():
        section.checks.append(CheckResult(
            ...
            recommendation=(
                "Run AI workloads as a non-root user with minimal privileges."
            ),
        ))
        section.security_findings.append(SecurityFinding(
